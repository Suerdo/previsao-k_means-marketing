...
st.write("""
         ...
         Através dessa análise, foi possível segmentar o público em bolhas de interesse, permitindo a criação de campanhas personalizadas e mais assertivas, com base nos padrões de comportamento e preferências de cada grupo.
         """)
...
def processar_prever (df):
    ...
    cluster = kmean.predict(dados_escalados)
...
if up_file is not None:
    ...
    st.write('Vizualização dos resultados (10 primeiros registros): ')
    st.write(df.head(10))
